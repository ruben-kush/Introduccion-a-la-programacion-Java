...
public class App {
  ...
  public static void main(String[] args) {
    ...
    while (running) {
      ...
      System.out.println("6. Subtract stock");
      ...
      switch (option) {
        ...
        case 5:
          ...
          break;
        case 6:
          System.out.print("Enter article's code that you want to subtract stock: ");
          String codeToSubtractStock = sc.nextLine();
          System.out.print("How many units would you like to subtract?: ");
          int unitsToSubtract = sc.nextInt();
          sc.nextLine();
          storage.subtractStock(codeToSubtractStock, unitsToSubtract);
          break;
        case 7:
